...
/**
 * Implements the link-based optimizer
 * @author Venktesh
 */
public abstract class LinkBasedOptimizer extends UEROptimizer{

    boolean solveMSOR;
    
    public LinkBasedOptimizer(Network network) {
        super(network);
        solveMSOR = false;
    }

    public LinkBasedOptimizer(Network network, Integer maxIters) {
        super(network, maxIters);
        solveMSOR = false;
    }

    public LinkBasedOptimizer(Network network, Integer maxIters, Integer exp) {
        super(network, maxIters, exp);
        solveMSOR = false;
    }
    
    public LinkBasedOptimizer(Network network, Integer maxIters, Integer exp, boolean temp) {
        super(network, maxIters, exp);
        solveMSOR = temp;
    }
    ...
    public void iterate(int itrNo) {
        ...
        double lambda = getStepSizeLambda(itrNo);
...
//                        ns.getMinCostToDestination()*ns.getInfo().getProbability());
    ...
    public abstract double getStepSizeLambda(int itrNo);
